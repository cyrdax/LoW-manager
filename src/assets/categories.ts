...
const ARMOR_MODULE_GROUP_IDS = new Set([62, 325, 326, 328, 329, 773, 1150, 1199, 1698, 1699, 2018]);
const SHIELD_MODULE_GROUP_IDS = new Set([38, 39, 40, 41, 57, 77, 295, 338, 770, 774, 1156, 1697, 1700]);
